...
\noindent\textbf{Alcance del artículo derivado.} Un manuscrito en inglés derivado de esta tesis se centra exclusivamente en la rama de efecto Allee \emph{fuerte} (cuatro escenarios espaciales con $\mathcal{R}\in\{0,1\}$ y control Hill on/off). La tesis completa reporta además la rama de Allee débil y diez escenarios homogéneos sistemáticos.
