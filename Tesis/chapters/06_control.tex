...
\paragraph{Parámetros comunes en todos los casos Strong.} En las comparativas se fijaron: $a=0.1$, $\gamma=0.74$, $\alpha=10.22$, $r_s=13.12$; en las simulaciones PDE se usaron difusiones $D_c=0.012$, $D_s=D_i=0.022$, paso temporal $dt=10^{-3}$, $T=3$, malla $100\times100$ en dominio $[0,4]^2$, y control adaptativo tipo Hill $u=u_{\max}\,H_{\mathrm{act}}(c;K_c,n_c)\,H_{\mathrm{inh}}(i;K_i,n_i)$ con $u_{\max}=1$ cuando aplica.
